...
subroutine calc_cov_spin0(ac_bd, ad_bc, l_threshold, l_toeplitz, cov_array)
    implicit none
    ...
    if (l_toeplitz .lt. nlmax) then
        ...
        do l1 = l_toeplitz+1, nlmax
            ...
            do l3= lmin, lmax
                i   = l3 - lmin + 1
                cov_array(l1-1,l1-1,1) =cov_array(l1-1,l1-1,1)+ (ac_bd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1,l1-1,2) =cov_array(l1-1,l1-1,2)+ (ad_bc(l3+1)*thrcof0(i)**2d0)
            end do
        end do
    end if
...
subroutine calc_cov_spin0and2_simple(TaTcTbTd, TaTdTbTc, PaPcPbPd, PaPdPbPc, &
                                   ...
                                   & l_threshold, l_toeplitz, cov_array)
    ...
    if (l_toeplitz .lt. nlmax) then
        ...
        do l1 = l_toeplitz + 1, nlmax
            ...
            do l3= lmin, lmax
                i   = l3 - lmin + 1
                cov_array(l1-1, l1-1, 1) = cov_array(l1-1, l1-1, 1) + (TaTcTbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 2) = cov_array(l1-1, l1-1, 2) + (TaTdTbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 3) = cov_array(l1-1, l1-1, 3) + (PaPcPbPd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 4) = cov_array(l1-1, l1-1, 4) + (PaPdPbPc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 5) = cov_array(l1-1, l1-1, 5) + (TaTcPbPd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 6) = cov_array(l1-1, l1-1, 6) + (TaPdPbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 7) = cov_array(l1-1, l1-1, 7) + (PaPcTbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 8) = cov_array(l1-1, l1-1, 8) + (PaTdTbPc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 9) = cov_array(l1-1, l1-1, 9) + (TaPcTbPd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 10) = cov_array(l1-1, l1-1, 10) + (TaPdTbPc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 11) = cov_array(l1-1, l1-1, 11) + (TaTcTbPd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 12) = cov_array(l1-1, l1-1, 12) + (TaPdTbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 13) = cov_array(l1-1, l1-1, 13) + (TaPcTbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 14) = cov_array(l1-1, l1-1, 14) + (TaTdTbPc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 15) = cov_array(l1-1, l1-1, 15) + (TaPcPbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 16) = cov_array(l1-1, l1-1, 16) + (TaTdPbPc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 17) = cov_array(l1-1, l1-1, 17) + (TaPcPbPd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 18) = cov_array(l1-1, l1-1, 18) + (TaPdPbPc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 19) = cov_array(l1-1, l1-1, 19) + (PaPcTbPd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 20) = cov_array(l1-1, l1-1, 20) + (PaPdTbPc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 21) = cov_array(l1-1, l1-1, 21) + (TaTcPbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 22) = cov_array(l1-1, l1-1, 22) + (TaTdPbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 23) = cov_array(l1-1, l1-1, 23) + (PaTcTbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 24) = cov_array(l1-1, l1-1, 24) + (PaTdTbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 25) = cov_array(l1-1, l1-1, 25) + (PaTcPbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 26) = cov_array(l1-1, l1-1, 26) + (PaTdPbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 27) = cov_array(l1-1, l1-1, 27) + (PaTcTbPd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 28) = cov_array(l1-1, l1-1, 28) + (PaPdTbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 29) = cov_array(l1-1, l1-1, 29) + (PaTcPbPd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 30) = cov_array(l1-1, l1-1, 30) + (PaPdPbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 31) = cov_array(l1-1, l1-1, 31) + (PaPcPbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 32) = cov_array(l1-1, l1-1, 32) + (PaTdPbPc(l3+1)*thrcof0(i)**2d0)
            end do
        end do
    end if
    ...
    if (l_toeplitz .lt. nlmax) then
        ...
        do l1 = l_toeplitz + 1, nlmax
            ...
            do l3= lmin, lmax
                ...
                cov_array(l1-1, l1-1, 1) = cov_array(l1-1, l1-1, 1) + (TaTcTbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 2) = cov_array(l1-1, l1-1, 2) + (TaTdTbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 3) = cov_array(l1-1, l1-1, 3) + (PaPcPbPd(l3+1)*thrcof1(i)**2*(1+(-1)**(l1+l1+l3))/2)
                cov_array(l1-1, l1-1, 4) = cov_array(l1-1, l1-1, 4) + (PaPdPbPc(l3+1)*thrcof1(i)**2*(1+(-1)**(l1+l1+l3))/2)
                cov_array(l1-1, l1-1, 5) = cov_array(l1-1, l1-1, 5) + (TaTcPbPd(l3+1)*thrcof0(i)*thrcof1(i))
                cov_array(l1-1, l1-1, 6) = cov_array(l1-1, l1-1, 6) + (TaPdPbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 7) = cov_array(l1-1, l1-1, 7) + (PaPcTbTd(l3+1)*thrcof0(i)*thrcof1(i))
                cov_array(l1-1, l1-1, 8) = cov_array(l1-1, l1-1, 8) + (PaTdTbPc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 9) = cov_array(l1-1, l1-1, 9) + (TaPcTbPd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 10) = cov_array(l1-1, l1-1, 10) + (TaPdTbPc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 11) = cov_array(l1-1, l1-1, 11) + (TaTcTbPd(l3+1)*thrcof0(i)**2d0)
                ...
                cov_array(l1-1, l1-1, 14) = cov_array(l1-1, l1-1, 14) + (TaTdTbPc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 15) = cov_array(l1-1, l1-1, 15) + (TaPcPbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 16) = cov_array(l1-1, l1-1, 16) + (TaTdPbPc(l3+1)*thrcof0(i)*thrcof1(i))
                cov_array(l1-1, l1-1, 17) = cov_array(l1-1, l1-1, 17) + (TaPcPbPd(l3+1)*thrcof1(i)**2*(1+(-1)**(l1+l1+l3))/2)
                cov_array(l1-1, l1-1, 18) = cov_array(l1-1, l1-1, 18) + (TaPdPbPc(l3+1)*thrcof1(i)**2*(1+(-1)**(l1+l1+l3))/2)
                cov_array(l1-1, l1-1, 19) = cov_array(l1-1, l1-1, 19) + (PaPcTbPd(l3+1)*thrcof1(i)**2*(1+(-1)**(l1+l1+l3))/2)
                cov_array(l1-1, l1-1, 20) = cov_array(l1-1, l1-1, 20) + (PaPdTbPc(l3+1)*thrcof1(i)**2*(1+(-1)**(l1+l1+l3))/2)
                cov_array(l1-1, l1-1, 21) = cov_array(l1-1, l1-1, 21) + (TaTcPbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 22) = cov_array(l1-1, l1-1, 22) + (TaTdPbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 23) = cov_array(l1-1, l1-1, 23) + (PaTcTbTd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 24) = cov_array(l1-1, l1-1, 24) + (PaTdTbTc(l3+1)*thrcof0(i)**2d0)
                ...
                cov_array(l1-1, l1-1, 26) = cov_array(l1-1, l1-1, 26) + (PaTdPbTc(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 27) = cov_array(l1-1, l1-1, 27) + (PaTcTbPd(l3+1)*thrcof0(i)**2d0)
                cov_array(l1-1, l1-1, 28) = cov_array(l1-1, l1-1, 28) + (PaPdTbTc(l3+1)*thrcof0(i)*thrcof1(i))
                cov_array(l1-1, l1-1, 29) = cov_array(l1-1, l1-1, 29) + (PaTcPbPd(l3+1)*thrcof1(i)**2*(1+(-1)**(l1+l1+l3))/2)
                cov_array(l1-1, l1-1, 30) = cov_array(l1-1, l1-1, 30) + (PaPdPbTc(l3+1)*thrcof1(i)**2*(1+(-1)**(l1+l1+l3))/2)
                cov_array(l1-1, l1-1, 31) = cov_array(l1-1, l1-1, 31) + (PaPcPbTd(l3+1)*thrcof1(i)**2*(1+(-1)**(l1+l1+l3))/2)
                cov_array(l1-1, l1-1, 32) = cov_array(l1-1, l1-1, 32) + (PaTdPbPc(l3+1)*thrcof1(i)**2*(1+(-1)**(l1+l1+l3))/2)
            end do
        end do
    end if
